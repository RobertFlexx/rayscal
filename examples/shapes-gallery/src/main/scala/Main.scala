  ...
  Window.withWindow(900, 520, "rayscal - shapes gallery"):
    ...
    while !Window.shouldClose do
      Zone:
        ...
        val lineThickness = if Mouse.isDown(MouseButtons.Left) then 8.0f else 3.0f
        ...
        Drawing.frame:
          ...
          Shapes.polygon(Vector.vector2(150.0f, 380.0f), 6, 62.0f, rotation, Colors.GOLD)
          Shapes.ring(Vector.vector2(360.0f, 380.0f), 38.0f, 68.0f, 0.0f, 300.0f, 48, Colors.RED)
          Shapes.line(Vector.vector2(480.0f, 380.0f), mouse, lineThickness, Colors.BLUE)
